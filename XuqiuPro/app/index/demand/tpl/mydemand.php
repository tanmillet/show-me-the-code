...
<!--            <input type="text" class="span3" name="title" value="--><?php //echo $_GET['title'];?><!--" placeholder="需求标题"  />-->
            <select name="deptid">
...
<!--        <th nowrap="nowrap">需求ID</th>-->
        <th nowrap="nowrap">优先级</th>
        <th nowrap="nowrap">需求标题</th>
        <th nowrap="nowrap">担当部门</th>
<!--        <th nowrap="nowrap">需求内容</th>-->
<!--        <th nowrap="nowrap">附件地址</th>-->
        <th nowrap="nowrap">需求状态</th>
        <th nowrap="nowrap">创建用户</th>
...
<!--            </td>-->
            <td>
<!--                <input type="text" style="width: 20px;" readonly value="--><?php //echo $demand['priority'];?><!--" id="--><?php //echo 'pri_'.$demand['id']?><!--">-->
...
<!--            </td>-->
            ...
            <td>
                ...
                switch($demand['status'])
                {
                    ...
                    case 2:
                    ?>
                    <a class="btn btn-danger" onclick="opDemand(3,<?php echo $demand['id'];?>,<?php echo $demand['status'];?>,'KS','mydemand')" href="javascript:void(0);">开始</a>
                    <?php
                    case 3:
                        ?>
                        <a class="btn btn-danger" onclick="opDemand(4,<?php echo $demand['id'];?>,<?php echo $demand['status'];?>,'JS','mydemand')" href="javascript:void(0);">完成</a>
                        <?php
                    case 4:
                        ?>

                        <a class="btn btn-info" onclick="opDemand(2,<?php echo $demand['id'];?>,<?php echo $demand['status'];?>,'CZ','mydemand')" href="javascript:void(0);">重置</a>
                        <?php
                        break;
                    case 5:
                        ?>
                        ...
                        break;}
                ?>
<!--                <a class="btn btn-info" title="--><?php //echo $demand['id'];?><!--" href="?m=--><?php //echo $_GET['m'];?><!--&p=edit&id=--><?php //echo $demand['id'];?><!--&demandstatus=--><?php //echo $demand['status'];?><!--&my=mydemand">编辑</a>-->
<!--                <a class="btn btn-info" href="?m=--><?php //echo $_GET['m'];?><!--&p=comment&id=--><?php //echo $demand['id'];?><!--&demandstatus=--><?php //echo $demand['status'];?><!--&my=mydemand">评论</a>-->
            </td>
